...
| `@zuke/qr`                                                                                                                                          | `QrTasks`                                                 | `print`/`render`/`encode` a QR code for the terminal (no `qrencode` needed) — `QrTasks.print(this.url.value, (s) => s.errorCorrection("Q"))` hands a URL to the room                                                                                                                                                                                                                                                                                                                                   |
