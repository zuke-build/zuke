...
| `@zuke/qr`                                                                                                                                          | `QrTasks`                                                 | `print`/`render`/`encode` a QR code for any data — URLs, Wi-Fi and login strings, tokens, JSON — as terminal output, text lines or the raw module matrix; no `qrencode` needed                                                                                                                                                                                                                                                                                                                         |
