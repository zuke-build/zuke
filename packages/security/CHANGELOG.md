...
* graduate `@zuke/security` to 1.0.0 — the package now follows full semver, so a breaking change bumps its major version
...
## [0.2.1](https://github.com/zuke-build/zuke/compare/security-v0.2.0...security-v0.2.1) (2026-07-19)
...
## [0.2.0](https://github.com/zuke-build/zuke/compare/security-v0.1.0...security-v0.2.0) (2026-06-16)
