...
export interface TofuTasksApi {
  ...
  destroy(
    configure?: Configure<TofuDestroySettings>,
  ): Promise<CommandOutput>;
  ...
  output(
    configure?: Configure<TofuOutputSettings>,
  ): Promise<CommandOutput>;
}
